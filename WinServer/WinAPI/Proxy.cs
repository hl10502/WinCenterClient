namespace WinAPI
{
    ...
    public interface Proxy : IXmlRpcProxy
    {
        ...
        Response<string> async_host_get_uncooperative_resident_vms(string session, string _self);
        ...
        Response<string> async_pool_apply_edition(string session, string _self, string _edition);
        ...
        Response<string> async_pool_get_license_state(string session, string _self);
        ...
        Response<string> async_vm_get_cooperative(string session, string _self);
        ...
        Response<string[]> host_get_uncooperative_resident_vms(string session, string _self);
        ...
        Response<string> pool_apply_edition(string session, string _self, string _edition);
        ...
        Response<object> pool_get_license_state(string session, string _self);
        ...
        Response<bool> vm_get_cooperative(string session, string _self);
