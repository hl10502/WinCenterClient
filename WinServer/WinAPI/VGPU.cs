namespace WinAPI
{
    ...
    public class VGPU : XenObject<VGPU>
    {
        ...
        public VGPU(string uuid, XenRef<WinAPI.VM> VM, XenRef<WinAPI.GPU_group> GPU_group, string device, bool currently_attached, Dictionary<string, string> other_config)
        {
            this.uuid = uuid;
            this.VM = VM;
        ...
        {
            return new Proxy_VGPU { uuid = (this.uuid != null) ? this.uuid : "", VM = (this.VM != null) ? ((string) this.VM) : "", GPU_group = (this.GPU_group != null) ? ((string) this.GPU_group) : "", device = (this.device != null) ? this.device : "", currently_attached = this.currently_attached, other_config = Maps.convert_to_proxy_string_string(this.other_config) };
        }
